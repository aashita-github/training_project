...
public class FlightView {
    ...
    /**
     * Sort flights by flight fare 
     * @param unsortedlistbyfare
     */
    public static void viewFlightsByFare(List<Flight> unsortedlistbyfare) {
        ...
        System.out.println("\n \t\t ***** FLIGHT INFORMATION *****");
        System.out.println("FLIGHT_NO|DEP_LOC|ARR_LOC|VALID_TILL|FLIGHT_TIME|FARE  |FLIGHT_DURN|CLASS_TYPE\n");
        for(Flight b:list1){
        
            flag=1;
            if(b.getClassType().equals("B"))
            {
            	 System.out.println(b.getFlightNo()+"\t |"+b.getDepLoc()+"\t | "+b.getArrLoc()+"\t |"+b.getValidTill()+"| "+b.getFlightTime()+"\t |"+(b.getFare()*1.4)+"\t| "+b.getFlightDur()+"\t|"+b.getClassType()+"\t|");
            }
            System.out.println(b.getFlightNo()+"\t |"+b.getDepLoc()+"\t | "+b.getArrLoc()+"\t |"+b.getValidTill()+"| "+b.getFlightTime()+"\t |"+(b.getFare())+"\t| "+b.getFlightDur()+"\t|"+b.getClassType()+"\t|");
        }
        ...
        if(flag==0)
        {
        	...
        	System.out.println("\n\tNo Flights Available for this Arrival and Departure location\t\n");
        }
       

    }
    /**
     * To sort flight by flight duration
     * @param unsortedlistbytime
     */
