...
<body style="background-color: #222D32;font-size: 10px;
    ...
    <div class="container mt-5 mx-auto">
        <div class="row">
              <div class="col-lg pl-2" style="background-color:#222D32;">
                  <h5 class="text-primary p-1">Forgot password </h5>
              </div>              
        </div>
        <div class="row" style="background-color:#222D32;">
              <form action="forgotpassword" method="post" class="col-sm-12 col-lg-12 col-md-12 mt-3 pl-2">        
                ...
                <div class="form-group row">
                       <label for="Email" class="col-sm-2 col-lg-3 col-form-label">New Password:</label>
                       <label style="color: red;">*</label>
                       <div class="col-sm-6 col-md-8 col-lg-5">
                ...
                <div class="form-group row">
                       <label for="Email" class="col-sm-2 col-lg-3 col-form-label">Confirm New Password:</label>
                       <label style="color: red;">*</label>
                       <div class="col-sm-6 col-md-8 col-lg-5">
                           <input type="password" required class="form-control" style="height: 30px; border-radius: 0px;" name="cpass">
                       </div>
                </div>
		...
		<%
			...
			%>
                ...
                <label for="Email" class="col-sm-2 col-lg-3 col-form-label"></label>      
                       <div class="col-lg d-flex flex-row-reverse p-3 ml-2">
